...
class ControllerAffiliateRegister extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->customer->login($this->request->post['email'], $this->request->post['password']);//technics add this
...
//technics start
		...
		$activeFields = $this->model_extension_module_technics->getFields($this->config->get('config_customer_group_id'),0);
...
//technics start				
		...
		$ignoredFields = $this->model_extension_module_technics->getIgnoredFields($this->config->get('config_customer_group_id'),0);

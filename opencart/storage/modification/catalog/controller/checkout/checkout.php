...
class ControllerCheckoutCheckout extends Controller {
	public function index() {
		...
		// technics
		$this->load->language('extension/theme/technics');
		$data['text_technics_checkout_s1'] = $this->language->get('text_technics_checkout_s1');
		$data['text_technics_checkout_s2'] = $this->language->get('text_technics_checkout_s2');
		$data['text_technics_checkout_s3'] = $this->language->get('text_technics_checkout_s3');
		$data['text_technics_checkout_s4'] = $this->language->get('text_technics_checkout_s4');
		...
		$data['show_checkout_shipping'] = $this->config->get('theme_technics_checkout_shipping');
		$data['fixed_cart'] = $this->config->get('theme_technics_checkout_fixed_cart');

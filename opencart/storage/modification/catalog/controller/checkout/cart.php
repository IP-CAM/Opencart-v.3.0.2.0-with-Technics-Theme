...
class ControllerCheckoutCart extends Controller {
	public function index() {
		...
		$data['schema'] = $this->config->get('theme_technics_schema');
			...
			$data['text_fastorder_name'] = $this->language->get('text_technics_name');
			$data['text_fastorder_phone'] = $this->language->get('text_technics_phone');
			$data['text_fastorder_comment'] = $this->language->get('text_technics_comment');
			...
			$data['text_technics_cart_price'] = $this->language->get('text_technics_cart_price');
			$data['text_technics_reward'] = $this->language->get('text_technics_reward');
		// technics end
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			foreach ($products as $product) {
				...
				$data['products'][] = array(
					...
					'reward_num'=> $product['reward'],// technics add
			...
			$data['buyclick_form'] = $this->load->view('product/buyclick_form', $data);//Technics added this
...
// technics
	...
	public function setadd() {
		...
		$this->session->data['technicssetid'][] = $setid;

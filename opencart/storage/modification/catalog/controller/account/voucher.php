...
class ControllerAccountVoucher extends Controller {
	...
	public function index() {
		...
		// technics
		if ($this->config->get('theme_technics_voucher_pdata')) {
			$this->load->language('extension/theme/technics');
			$this->load->model('catalog/information');

			$information_info = $this->model_catalog_information->getInformation($this->config->get('theme_technics_voucher_pdata'));

			if ($information_info) {
				$data['text_technics_pdata_checkbox'] = sprintf($this->language->get('text_technics_pdata_checkbox'), $this->url->link('information/information/agree', 'information_id=' . $this->config->get('theme_technics_voucher_pdata'), true), $information_info['title'], $information_info['title']);
			} else {
				$data['text_technics_pdata_checkbox'] = '';
			}
		} else {
			$data['text_technics_pdata_checkbox'] = '';
		}
	...
	protected function validate() {
		...
		if ($this->config->get('theme_technics_voucher_pdata')) {
			...
			if ($information_info && !isset($this->request->post['pdata'])) {
				$this->error['error_pdata'] = sprintf($this->language->get('text_technics_error_pdata'), $information_info['title']);
			}
		}
		// technics end

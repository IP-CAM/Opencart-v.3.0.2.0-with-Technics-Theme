...
// technics
			if ($this->config->get('theme_technics_image_manufacturer_resize')) {
				if ($result['image']) {
					$image = $this->model_tool_image->technics_resize($result['image'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_manufacturer_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_manufacturer_height'));
				} else {
...
$data['column_left']  = $this->load->controller('common/column_left');
	...
	public function info() {
		...
		$data['language_id'] = $this->config->get('config_language_id'); //technics added this		

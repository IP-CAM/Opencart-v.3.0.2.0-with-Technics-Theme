...
// technics
			...
			if ($this->user->hasPermission('access', 'extension/theme/technics')) {
				$stores = $this->model_setting_store->getStores();
				
				if ($stores) {
					$technics_store = array();

					$technics_store[] = array(
							'name'	   => (utf8_strlen($this->config->get('config_name')) > 12 ? utf8_substr($this->config->get('config_name'), 0, 12) . '..' : $this->config->get('config_name')),
							'href'     => $this->url->link('extension/theme/technics', 'user_token=' . $this->session->data['user_token'] . '&store_id=0', true),
							'children' => array()		
					);
					...
					foreach ($stores as $store) {
						$technics_store[] = array(
							...
							'href'     => $this->url->link('extension/theme/technics', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $store['store_id'], true),
							'children' => array()	
						);
					}
					...
					if ($technics_store) {		
						$technics[] = array(
							'name'	   => $this->language->get('text_theme_technics_store'),
							'href'     => '',
							'children' => $technics_store		
						);					
					}
					
				} else {
					$technics[] = array(
						'name'	   => $this->language->get('text_theme_technics'),
						'href'     => $this->url->link('extension/theme/technics', 'user_token=' . $this->session->data['user_token'] . '&store_id=0', true),
						'children' => array()		
					);					
				}
			...
			if ($this->user->hasPermission('access', 'extension/module/technics/callback')) {
				$technics[] = array(
					'name'	   => $this->language->get('text_callback'),
					'href'     => $this->url->link('extension/module/technics/callback', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'extension/module/technics/subscribe')) {
				$technics[] = array(
					'name'	   => $this->language->get('text_subscribe'),
					'href'     => $this->url->link('extension/module/technics/subscribe', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}

			if ($this->user->hasPermission('access', 'extension/module/technics/technics_sets')) {		
				$technics[] = array(
					'name'	   => $this->language->get('text_technics_sets'),
					'href'     => $this->url->link('extension/module/technics/technics_sets', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}			
			if ($this->user->hasPermission('access', 'extension/module/technics/technics_news')) {		
				$technics[] = array(
					'name'	   => $this->language->get('text_technics_news'),
					'href'     => $this->url->link('extension/module/technics/technics_news', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}
			if ($this->user->hasPermission('access', 'extension/module/technics/technics_tab')) {		
				$technics[] = array(
					'name'	   => $this->language->get('text_technics_tab'),
					'href'     => $this->url->link('extension/module/technics/technics_tab', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/technics/technics_blog')) {
				$blog[] = array(
					'name'     => $this->language->get('text_technics_blog'),
					'href'     => $this->url->link('extension/module/technics/technics_blog', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()	
				);
			}
			
			if ($this->user->hasPermission('access', 'extension/module/technics/technicscat_blog')) {
				$blog[] = array(
					'name'	   => $this->language->get('text_technicscat_blog'),
					'href'     => $this->url->link('extension/module/technics/technicscat_blog', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($this->user->hasPermission('access', 'extension/module/technics/technicsblog_review')) {
				$blog[] = array(
					'name'	   => $this->language->get('text_technicsblog_review'),
					'href'     => $this->url->link('extension/module/technics/technicsblog_review', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($blog) {		
				$technics[] = array(
					'name'	   => $this->language->get('text_technics_blog_main'),
					'href'     => '',
					'children' => $blog		
				);					
			}
			...
			if ($technics) {
				$data['menus'][] = array(
					'id'       => 'menu-technics',
					'icon'	   => 'technics', 
					'name'	   => $this->language->get('text_technics'),
					'href'     => '',
					'children' => $technics
				);		
			}

...
// technics
$_['text_subscribe']          	    		= 'Подписка на новости';// technics
$_['text_technics_news']          	    	= 'Новости';// technics
$_['text_technics_blog_main']          	= 'Блог';// technics
$_['text_technicscat_blog']          	    = 'Категории';// technics
$_['text_technics_blog']          	    	= 'Статьи';// technics
$_['text_technicsblog_review']          	= 'Отзывы';// technics
$_['text_technics_sets']        		  	= 'Наборы';// technics
$_['text_technics']        		  		= 'Техникс';// technics
$_['text_theme_technics']        		  	= 'Настройка шаблона';// technics
$_['text_theme_technics_store']        	= 'Настройка';// technics
$_['text_technics_tab']          	    	= 'Вкладки к товарам';// technics

...
class ModelCatalogReview extends Model {
	...
	public function editReview($review_id, $data) {
		...
		//technics
		$this->db->query("UPDATE " . DB_PREFIX . "review_extls SET review_id = '" . (int)$review_id . "', text_plus  = '" . $this->db->escape($data['text_plus']) . "', text_minus = '" . $this->db->escape($data['text_minus']) . "' WHERE review_id = '" . (int)$review_id . "'");
		// technics end	
